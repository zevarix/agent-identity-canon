...
An operator-assigned job, role, goal, style, or behavior requirement also does not automatically become identity. Preserve external authorship explicitly; do not use canon as a disguised behavioral-control layer. Behavior-bearing externally assigned values require a later detached identity review before they may become current canon. See `docs/IDENTITY-AUTHORSHIP.md`.
